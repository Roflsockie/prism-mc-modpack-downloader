...
### Fixed
- Исправлен баг в поиске сборок.

### Changed
- Убрана пелена с фонового изображения — картинка теперь видна чётко.
- Приведены цвета UI к единой палитре (коричневый, бежевый, салатовый, серый) — убраны розовые и синие акценты.
